# Fabric Notebook
# Migrated from SSIS Package: FileSizes
# Task: ShowFileNames
# Task Type: SCRIPT
...
# === Completion ===
logger.info("Notebook completed: ShowFileNames")
print("Migration notebook execution complete: ShowFileNames")
